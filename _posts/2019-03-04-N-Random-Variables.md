...
Back to the graphical analogy, the angle between each pair of vectors becomes $\arccos -\frac{1}{N - 1}$, pushing them towards being orthogonal to each other in the limit.
